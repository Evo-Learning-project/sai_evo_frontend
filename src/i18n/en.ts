...
export const en = {
	...
	practice_template_editor: {
		...
		choose_exercises_text: "Select the tags you're interested in in order to create your practice session.",
	...
	programming_exercise: {
		...
		no_testcases: "This exercise doesn't have any test cases. Try asking your teacher to add some.",
		...
		code_execution_will_appear_here: "The execution results for your code will appear here.",
	},
	event_states: {
	...
	exercise_types: {
		...
		[ExerciseType.MULTIPLE_CHOICE_MULTIPLE_POSSIBLE]: "Multiple choices, more than one correct",
	...
	help_texts: {
		...
		exercise_editor: {
			score_if_checked: "100% means correct answer. You can use negative values to apply a penalty",
	...
	event_template_rule_editor: {
		...
		one_exercise_from_set_description: "Each student will be shown a randomly picked exercise among these:",
	...
	event_assessment: {
		...
		some_slots_pending: "The grade shown is incomplete because you haven't yet assigned a score to some exercises.",
		default_score:
		...
		overall_score_instructions:
			"You can assign a grade manually to this student. The grade can be" + " a number or a string.",
	},
};
