<template>
	<select
		...
		:value="modelValue"
	>
		<option v-if="!isThereDefault" class="text-muted" :value="NULL_VALUE" disabled>
			{{ $t("misc.select_empty_option") }}
		</option>
		<option
...
export default defineComponent({
	...
	computed: {
		...
		isThereDefault() {
			return this.options?.some((o: { value: string }) => o.value == this.NULL_VALUE);
		},
	},
});
</script>
