  ...
  <div class="">
    <div class="flex items-center w-full">
      ...
      <NumberInput
        ...
        @update:modelValue="
          $emit('partialUpdate', { field: 'amount', value: $event })
        "
      ></NumberInput>
      ...
      <SegmentedControls
        ...
        @update:modelValue="
          $emit('partialUpdate', { field: 'rule_type', value: $event })
        "
      ></SegmentedControls>
      ...
      return [
        {
          ...
          content: _(
            'event_template_rule_type.' + EventTemplateRuleType.TAG_BASED
          )
        },
        {
          value: EventTemplateRuleType.FULLY_RANDOM,
          content: _(
            'event_template_rule_type.' + EventTemplateRuleType.FULLY_RANDOM
          )
        }
      ]
    }
