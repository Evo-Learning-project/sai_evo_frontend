			...
			>
				<div class="flex items-center space-x-1">
					...
					<p
						...
						:class="{
							'text-yellow-400': mainStore.gamificationContext.leaderboard_position === 1,
							'text-gray-400': mainStore.gamificationContext.leaderboard_position === 2,
							'text-yellow-900': mainStore.gamificationContext.leaderboard_position === 3,
						}"
					>
